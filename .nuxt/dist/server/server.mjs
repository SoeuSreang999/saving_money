...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-j4Sf3o0L.js").then((m) => m.default || m)
  },
  {
    name: "users",
    path: "/users",
    component: () => import("./_nuxt/index-BRo4cdrU.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Df2mLGjZ.js").then((r) => r.default || r));
